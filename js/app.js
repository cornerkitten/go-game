...
function setup(boardSize, documentHandle, canvasId) {
	...
	let view = new CanvasView(documentHandle, canvasId);
	...
	spriteManager.load(() => {
		view.drawSprite(sprites.gameBoard, 0, 0);
		view.drawCanvas(canvasSprites.grid, 0, 0);
	});
